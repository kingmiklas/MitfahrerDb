...
insert into mitfahrerdb.tpostedrides(dDatumUhrzeit, cStartOrt, cZielOrt, nSitzplaetze, kErsteller)
Values ('2022-11-07 08:30:00', 'Wienerplatz', 'GSO', 4, 1);

insert into mitfahrerdb.tpostedrides(dDatumUhrzeit, cStartOrt, cZielOrt, nSitzplaetze, kErsteller)
Values ('2022-10-24 07:00:00', 'Neumarkt', 'GSO', 2,2);

insert into mitfahrerdb.tpostedrides(dDatumUhrzeit, cStartOrt, cZielOrt, nSitzplaetze, kErsteller)
Values ('2022-8-01 16:35:00', 'GSO', 'Frechen Einkaufscenter', 5, 3);
